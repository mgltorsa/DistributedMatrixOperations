...
public class ClientFCscaPrimitiveFC6807e11d
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("Runnable","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("server","co.edu.icesi.interfaces.IServer",true,true,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "co.edu.icesi.impl.Client";
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.content = co.edu.icesi.impl.Client.class;
    ...
    ic.controllers.add(intercept);
    proxy = new co.edu.icesi.interfaces.IServerFcOutItf(proxyForCompCtrl,"server",new org.objectweb.fractal.julia.type.BasicInterfaceType("server","co.edu.icesi.interfaces.IServer",true,true,false),false,intercept);
    ic.interfaces.put("server",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    initFcController(ic);
  ...
  public org.objectweb.fractal.api.Component newFcControllerInstantiation(org.objectweb.fractal.julia.InitializationContext ic) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.controllers.add(ctrl = new co.edu.icesi.impl.ClientFCSCAContentControllerImpl());
