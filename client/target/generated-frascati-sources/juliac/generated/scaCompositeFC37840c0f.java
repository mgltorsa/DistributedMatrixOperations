...
public class scaCompositeFC37840c0f
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("rotate","java.lang.Runnable",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new juliac.generated.java.lang.RunnableFcInItf(proxyForCompCtrl,"rotate",new org.objectweb.fractal.julia.type.BasicInterfaceType("rotate","java.lang.Runnable",false,false,false),false,intercept);
    ic.interfaces.put("rotate",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new juliac.generated.java.lang.RunnableFcOutItf(proxyForCompCtrl,"rotate",new org.objectweb.fractal.julia.type.BasicInterfaceType("rotate","java.lang.Runnable",true,false,false),true,intercept);
    ic.internalInterfaces.put("rotate",proxy);
    initFcController(ic);
