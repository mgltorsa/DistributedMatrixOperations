...
public class scaCompositeFC757c1dd9
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("balancer","co.edu.icesi.interfaces.IBalancer",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new co.edu.icesi.interfaces.IBalancerFcInItf(proxyForCompCtrl,"balancer",new org.objectweb.fractal.julia.type.BasicInterfaceType("balancer","co.edu.icesi.interfaces.IBalancer",false,false,false),false,intercept);
    ic.interfaces.put("balancer",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new co.edu.icesi.interfaces.IBalancerFcOutItf(proxyForCompCtrl,"balancer",new org.objectweb.fractal.julia.type.BasicInterfaceType("balancer","co.edu.icesi.interfaces.IBalancer",true,false,false),true,intercept);
    ic.internalInterfaces.put("balancer",proxy);
    initFcController(ic);
