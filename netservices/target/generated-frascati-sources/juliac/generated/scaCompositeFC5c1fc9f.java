...
public class scaCompositeFC5c1fc9f
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","co.edu.icesi.interfaces.IBroker",false,false,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    proxy = new co.edu.icesi.interfaces.IBrokerFcInItf(proxyForCompCtrl,"broker",new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","co.edu.icesi.interfaces.IBroker",false,false,false),false,intercept);
    ic.interfaces.put("broker",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    proxy = new co.edu.icesi.interfaces.IBrokerFcOutItf(proxyForCompCtrl,"broker",new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","co.edu.icesi.interfaces.IBroker",true,false,false),true,intercept);
    ic.internalInterfaces.put("broker",proxy);
    initFcController(ic);
