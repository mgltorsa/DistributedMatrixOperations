...
public class SerializerFCscaPrimitiveFC4f04f794
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("r","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("s","co.edu.icesi.interfaces.ISerializer",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","co.edu.icesi.interfaces.IBroker",true,true,false),} );
    }
  ...
  public Object getFcContentDesc()  {
      return "co.edu.icesi.impl.Serializer";
  }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.content = co.edu.icesi.impl.Serializer.class;
    ...
    intercept = new co.edu.icesi.interfaces.ISerializerInterceptorSCALCb56bb98SCACCIntent();
    ic.controllers.add(intercept);
    ((org.objectweb.fractal.julia.Interceptor)intercept).setFcItfDelegate(content);
    proxy = new co.edu.icesi.interfaces.ISerializerFcInItf(proxyForCompCtrl,"s",new org.objectweb.fractal.julia.type.BasicInterfaceType("s","co.edu.icesi.interfaces.ISerializer",false,false,false),false,intercept);
    ic.interfaces.put("s",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new co.edu.icesi.interfaces.IBrokerInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new co.edu.icesi.interfaces.IBrokerFcOutItf(proxyForCompCtrl,"broker",new org.objectweb.fractal.julia.type.BasicInterfaceType("broker","co.edu.icesi.interfaces.IBroker",true,true,false),false,intercept);
  ...
  public org.objectweb.fractal.api.Component newFcControllerInstantiation(org.objectweb.fractal.julia.InitializationContext ic) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    ic.controllers.add(ctrl = new co.edu.icesi.impl.SerializerFCSCAContentControllerImpl());
