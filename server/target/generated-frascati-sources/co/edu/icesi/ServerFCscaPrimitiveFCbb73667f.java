...
public class ServerFCscaPrimitiveFCbb73667f
...
implements org.objectweb.fractal.juliac.runtime.Factory {
  ...
  public org.objectweb.fractal.api.Type getFcInstanceType()  {
    try
    {
      return new org.objectweb.fractal.julia.type.BasicComponentType( new org.objectweb.fractal.api.type.InterfaceType[]{new org.objectweb.fractal.julia.type.BasicInterfaceType("r","java.lang.Runnable",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("s","co.edu.icesi.interfaces.IServer",false,false,false),new org.objectweb.fractal.julia.type.BasicInterfaceType("balancer","co.edu.icesi.interfaces.IBalancer",true,true,false),} );
    }
  ...
  public org.objectweb.fractal.api.Component newFcInstance(Object content) throws org.objectweb.fractal.api.factory.InstantiationException  {
    ...
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    intercept = new co.edu.icesi.interfaces.IBalancerInterceptorSCAIntent();
    ic.controllers.add(intercept);
    proxy = new co.edu.icesi.interfaces.IBalancerFcOutItf(proxyForCompCtrl,"balancer",new org.objectweb.fractal.julia.type.BasicInterfaceType("balancer","co.edu.icesi.interfaces.IBalancer",true,true,false),false,intercept);
    ic.interfaces.put("balancer",proxy);
    (( org.ow2.frascati.tinfi.TinfiComponentInterceptor )intercept).setFcItf(proxy);
    initFcController(ic);
